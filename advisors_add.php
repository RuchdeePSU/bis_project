<?php
    ...
    // form is submitted
    if (isset($_POST['btn_advisors_add'])) {
...
<div class="wrapper">
    ...
    <div id="page-content">
        ...
        <div class="container">
            <ol class="breadcrumb">
                <li>หน้าแรก</li>
                <li class="active">เพิ่มอาจารย์ที่ปรึกษาโครงงาน</li>
            </ol>
        </div>
        <!-- end Breadcrumb -->
        ...
        <div class="container">
            ...
            <!-- end Sidebar -->
                ...
                <div class="col-md-9 col-sm-10">
                    <section id="profile">
                        <header><h1>เพิ่มอาจารย์ที่ปรึกษาโครงงาน</h1></header>
                        <div class="account-profile">
                            <div class="row">
                                <div class="col-md-10 col-sm-10">
                                  <form role="form" id="form_advisors_add" method="post" action="<?php $_SERVER['PHP_SELF'] ?>">
                                      <section id="contact">
                                          <div class="row">
                                                  ...
                                                  <div class="form-group">
                                                      <div class="input-group">
                                                          ...
                                                          <select name="ddl_advisor_title" id="ddl_advisor_title">
                                                              <option value="ผศ.ดร." selected>ผศ.ดร.</option>
                                              ...
                                              <div class="col-md-8 col-sm-8">
                                                  <div class="form-group">
                                                      ...
                                                      <input type="text" class="form-control" id="advisor_fullname" name="advisor_fullname"></label>
                                                  </div><!-- /.form-group -->
                                              </div>
                                              <div class="col-md-2 col-sm-2">
                                              </div>
                                          ...
                                          <div class="row">
                                              <div class="col-md-6 col-sm-6">
                                                  <div class="form-group">
                                                      ...
                                                      <input type="text" class="form-control" id="advisor_email" name="advisor_email"></label>
                                                  </div><!-- /.form-group -->
                                              </div>
                                          ...
                                          <div class="row">
                                              <div class="block">
                                                  <div class="col-md-12 col-sm-12">
                                                      <div class="center">
                                                          <div class="form-group">
                                                              <button type="submit" class="btn btn-default large" name="btn_advisors_add">บันทึกข้อมูล</button>
                                                          </div><!-- /.form-group -->
                                                      </div>
                                                  </div>
                                              </div>
