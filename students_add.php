<?php
    ...
    // form is submitted
    if (isset($_POST['btn_students_add'])) {
...
<div class="wrapper">
    ...
    <div id="page-content">
        ...
        <div class="container">
            <ol class="breadcrumb">
                <li>หน้าแรก</li>
                <li class="active">เพิ่มนักศึกษาโครงงาน</li>
            </ol>
        </div>
        <!-- end Breadcrumb -->
        ...
        <div class="container">
            ...
            <!-- end Sidebar -->
                ...
                <div class="col-md-9 col-sm-10">
                    <section id="profile">
                        <header><h1>เพิ่มนักศึกษาโครงงาน</h1></header>
                        <div class="account-profile">
                            <div class="row">
                                <div class="col-md-10 col-sm-10">
                                  <form role="form" id="form_students_add" method="post" action="<?php $_SERVER['PHP_SELF'] ?>">
                                      <section id="contact">
                                          <div class="row">
                                              <div class="col-md-4 col-sm-4">
                                                  <div class="form-group">
                                                      <label for="student_id">รหัสนักศึกษา
                                                      <input type="text" class="form-control" id="student_id" name="student_id"></label>
                                                  </div><!-- /.form-group -->
                                              </div>
                                              ...
                                              <div class="col-md-6 col-sm-6">
                                                  <div class="form-group">
                                                      ...
                                                      <input type="text" class="form-control" id="student_fullname" name="student_fullname"></label>
                                                  </div><!-- /.form-group -->
                                              </div>
                                          </div>
                                          <div class="row">
                                              <div class="col-md-6 col-sm-6">
                                                  <div class="form-group">
                                                      ...
                                                      <input type="text" class="form-control" id="student_email" name="student_email"></label>
                                                  </div><!-- /.form-group -->
                                              </div>
                                              <div class="col-md-2 col-sm-2">
                                                  <div class="form-group">
                                          ...
                                          <div class="row">
                                              <div class="block">
                                                  <div class="col-md-12 col-sm-12">
                                                      <div class="center">
                                                          <div class="form-group">
                                                              <button type="submit" class="btn btn-default large" name="btn_students_add">บันทึกข้อมูล</button>
                                                          </div><!-- /.form-group -->
                                                      </div>
                                                  </div>
                                              </div>
