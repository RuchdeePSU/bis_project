...
<div class="wrapper">
            ...
            <header class="navbar" id="top" role="banner">
                ...
                <nav class="collapse navbar-collapse bs-navbar-collapse navbar-right" role="navigation">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="login_admin.php">ผู้ดูแลระบบ</a></li>
                    </ul>
                </nav><!-- /.navbar collapse-->
    ...
    <div id="page-content">
        ...
        <div class="container">
            <ol class="breadcrumb">
                <li>หน้าแรก</li>
                <li class="active">ลงชื่อเข้าใช้สำหรับผู้ดูแลระบบ (Sign In)</li>
            </ol>
        </div>
        <!-- end Breadcrumb -->

        <div class="container">
            <header><h1>ลงชื่อเข้าใช้สำหรับผู้ดูแลระบบ (Sign In)</h1></header>
            <div class="row">
                <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                    <form role="form" id="form-create-account" method="post" action="assets/php/admin_signin.php">
