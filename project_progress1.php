...
<head>
    ...
    <title>BIS Student Project Management System | 3. นำเสนอความก้าวหน้าครั้งที่ 1</title>
...
<div class="wrapper">
    ...
    <div id="page-content">
        ...
        <div class="container">
            <ol class="breadcrumb">
              <li>หน้าแรก</li>
              <li class="active">3. นำเสนอความก้าวหน้าครั้งที่ 1</li>
            </ol>
        </div>
        <!-- end Breadcrumb -->
                ...
                <section id="sidebar">
                    ...
                    <aside>
                        <ul class="sidebar-navigation">
                            ...
                            <li class="active"><a href="project_progress1.php"><i class="fa fa-bar-chart-o"></i><span>3. นำเสนอความก้าวหน้าครั้งที่ 1</span></a></li>
            ...
            <!-- end Sidebar -->
                ...
                <div class="col-md-9 col-sm-10">
                    <section id="my-properties">
                        <header><h1>3. นำเสนอความก้าวหน้าครั้งที่ 1</h1></header>
