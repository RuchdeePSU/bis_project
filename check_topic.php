<?php
    ...
    if (isset($_POST['btn_search'])) {
        if (!empty($_POST['txt_search'])) {
            if ($_POST['ddl_search_type'] == '0') {
                $project_topic->title_th = $_POST['txt_search'];
                $result = $project_topic->search_title();
                if (mysqli_num_rows($result) <= 0) {
                    $notfoud = true;
                } else {
                    $notfoud = false;
                }
            } elseif ($_POST['ddl_search_type'] == '1') {
                # code...
            }
        }
    } else {
        $result = $project_topic->search_nothing();
    }
...
<head>
    ...
    <style>
        h1, h2, h3, h4, h5, h6, legend, a, .btn, ul, th, td, address, span, label, input, .alert { font-family: 'Pridi', serif; }
    </style>

    <title>BIS Student Project Management System | ตรวจสอบหัวข้อโครงงาน</title>
...
<div class="wrapper">
    ...
    <div id="page-content">
        ...
        <div class="container">
            <ol class="breadcrumb">
              <li>หน้าแรก</li>
              <li class="active">ตรวจสอบหัวข้อโครงงาน</li>
            </ol>
        </div>
        <!-- end Breadcrumb -->
                ...
                <section id="sidebar">
                    ...
                    <aside>
                        <ul class="sidebar-navigation">
                            ...
                            <li class="active"><a href="check_topic.php"><i class="fa fa-search"></i><span>ตรวจสอบหัวข้อโครงงาน</span></a></li>
            ...
            <!-- end Sidebar -->
                ...
                <div class="col-md-9 col-sm-10">
                    <section id="my-properties">
                        <header><h1>ตรวจสอบหัวข้อโครงงาน</h1></header>
                        <div class="my-properties">
                            <form class="form" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                                <div class="row">
                                    <div class="col-md-3 col-sm-3">
                                        <div class="form-group">
                                            <label for="ddl_search_type">ต้องการค้นหา:</label>
                                            <select name="ddl_search_type" id="ddl_search_type">
                                                <option value="0" selected>หัวข้อโครงงาน</option>
                                                <option value="1">ชื่ออาจารย์ที่ปรึกษา</option>
                                                <option value="2">ชื่อนักศึกษา</option>
                                            </select>
                                        </div><!-- /.form-group -->
                                    </div><!-- /.col-md-9 -->
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-sm-8">
                                        <div class="input-group">
                                            <input type="search" class="form-control" placeholder="Search for..." id="txt_search" name="txt_search" required  oninvalid="this.setCustomValidity('ใส่ keyword ที่ต้องการค้นหา!')" onchange="this.setCustomValidity('')">
                                            <span class="input-group-btn">
                                              <button class="btn btn-default" type="submit" name="btn_search"><i class="fa fa-search"></i> ค้นหา!</button>
                                            </span>
                                        </div><!-- /input-group -->
                                    </div><!-- /.col-md-9 -->
                                ...
                                <div class="col-md-8 col-sm-8">
                                    <div class="center-block">
                                        <?php
                                          if (isset($notfoud)) {
                                              if ($notfoud) {
                                                  echo "<div class='alert alert-danger text-center'>ไม่พบข้อมูลที่ต้องการค้นหา!</div>";
                                              } else {
                                                  echo "";
                                              }
                                          }
