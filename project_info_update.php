<?php
    ...
    // fetch data from project_topics table
    $project_topic->topic_id = $_GET['topic_id'];
    $result_topic = $project_topic->readone();
    $row_topic = mysqli_fetch_array($result_topic);

    // fetch data from project_students table
    $project_student->topic_id = $_GET['topic_id'];
    $result_student = $project_student->readgroup();
    $no_students = mysqli_num_rows($result_student);
    if ($no_students == 2)  {
        while ($row_student = mysqli_fetch_array($result_student)) {
            if ($row_student['student_id'] != $_SESSION['student_id']) {
                $member_2_id = $row_student['student_id'];
                $member_2_title = $row_student['student_title'];
                $member_2_fullname = $row_student['student_fullname'];
            }
        }
    }
    if ($no_students == 3)  {
        ...
        while ($row_student = mysqli_fetch_array($result_student)) {
            if ($row_student['student_id'] != $_SESSION['student_id']) {
                ...
                if ($cnt == 2) {
                    ...
                    $member_3_id = $row_student['student_id'];
                    $member_3_title = $row_student['student_title'];
                    $member_3_fullname = $row_student['student_fullname'];
                }
            }
        }
    }
...
<head>
    ...
    <title>BIS Student Project Management System | แก้ไขข้อมูลโครงงาน</title>
...
<div class="wrapper">
    ...
    <div id="page-content">
        ...
        <div class="container">
            <ol class="breadcrumb">
              <li>หน้าแรก</li>
              <li class="active">แก้ไขโครงงาน</li>
            </ol>
        </div>
        <!-- end Breadcrumb -->
            ...
            <!-- end Sidebar -->
                ...
                <div class="col-md-9 col-sm-10">
                    <section id="my-properties">
                        <header><h1>แก้ไขโครงงาน</h1></header>
                            ...
                            <form role="form" id="project_topic_add" method="post" action="assets/php/project_info_save.php" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-9 col-sm-9">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="title_th" name="title_th" placeholder="ใส่ชื่อโครงงาน (ภาษาไทย)" maxlength="300" data-error="กรุณาใส่ชื่อโครงการ (ภาษาไทย)" value="<?php echo $row_topic['title_th']; ?>" required>
                                            <div class="help-block with-errors"></div>
                                        </div><!-- /.form-group -->
                                        <div class="form-group">
                                            <label for="title_en">ชื่อโครงงาน (English)</label>
                                            <input type="text" class="form-control" id="title_en" name="title_en" placeholder="ใส่ชื่อโครงงาน (English)" value="<?php echo $row_topic['title_en']; ?>" maxlength="300">
                                        </div><!-- /.form-group -->
                                    </div><!-- /.col-md-9 -->
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-body">
                                              <div id="selected_member_2">
                                                <?php if (isset($member_2_id)) {
                                                    echo "2. " . $member_2_id . " " . $member_2_title . $member_2_fullname . " <button type='button' class='btn btn-danger btn-xs' id='btn_member_2_del' name='btn_member_2_del'><i class='fa fa-trash-o'></i></button>";
                                                } ?>
                                              </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-body">
                                              <div id="selected_member_3">
                                                <?php if (isset($member_3_id)) {
                                                    echo "3. " . $member_3_id . " " . $member_3_title . $member_3_fullname . " <button type='button' class='btn btn-danger btn-xs' id='btn_member_3_del' name='btn_member_3_del'><i class='fa fa-trash-o'></i></button>";
                                                } ?>
                                              </div>
                                            </div>
                                        </div>
